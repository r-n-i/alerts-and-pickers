#
#  Be sure to run `pod spec lint RLBAlertsPickers.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "RLBAlertsPickers"
  spec.version      = "1.1.3"
  spec.summary      = "RLBAlertsPickers for iOS 14."
  ...
  spec.description  = <<-DESC
                      RLBAlertsPickers for iOS 14
                   DESC

  spec.homepage     = "https://github.com/r-n-i/alerts-and-pickers"
  ...
  spec.author             = { "ogawa-rni" => "k.ogawa@r-n-i.jp" }
  # Or just: spec.author    = "ogawa-rni"
  # spec.authors            = { "ogawa-rni" => "k.ogawa@r-n-i.jp" }
  # spec.social_media_url   = "https://twitter.com/ogawa-rni"
  ...
  spec.source       = { :git => "https://github.com/r-n-i/alerts-and-pickers.git", :tag => "#{spec.version}" }
...
#  ss.source_files  = "Source/Views/*.swift"  #,  "Source/Extensions", "Source/Pickers" # "Source/Extensions/*.{h,m}"
  ...
  #
   ...
   spec.framework  = "RLBAlertsPickers"
